...
exports.run = async (client, message, args) => {
	...
	var helpers = '! ŐŁŰM ★ Mertᵛᵉᵛᵒ#3786'
	...
	.setAuthor(`${client.user.username} | Bilgi ve İstatistikler`)
		...
		.addField("Botun Özel Linkleri", `[Sunucuna Ekle!](https://discordapp.com/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) | ${destek}`)
		.setTimestamp()
