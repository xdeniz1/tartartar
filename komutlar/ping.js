...
exports.run = async (bot, message, args) =>
{
  ...
  .setDescription('<:hayirr:508973336466948097> - Otorolü ayarlamak için bir rol etiketlemelisin. Otorol kanalıda ayarlamayı unutma! Bu arada rolü benden altta yapman lazım yoksa rolü veremem.')
  .setColor('RANDOM')
  ...
  .setTitle('Otorol ayarlandı!')
		.setDescription(`<:evett:508973323946819585> - Otorol bu sunucuda ${args[0]} olarak ayarlandı! Otorol kanalı ise ${mentionedChannel} olarak ayarlandı`)
		.setColor("RANDOM")
		.setTimestamp()
