...
client.ayarlar = {
	...
	site: "Site:www.trakyagaming22.tk", // Botunuzun web sitesi
  ...
  oyun: "{prefix}yardım | {sunucu} sunucu | {kullanıcı} kullanıcı {site} | MİNECRAFT SERVER:(✘) KAPALI ", // Minecraft Server:AÇIKSA (✅) KAPALIYSA (✘) | Oynuyor yeri, Burayı dilediğiniz şekilde değiştirebilirsiniz.
